...
export function ChairmanDeclineLoanModal({
  open,
  onClose,
  memberName,
  onDecline,
  ...
  return (
    <>
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              id="reason"
              placeholder="Explain why this Loan request is being declined..."
              rows={4}
      ...
      <ConfirmModal
        ...
        description={`Are you sure you want to decline 's ${memberName} Loan request? They will be notified with your reason.`}
